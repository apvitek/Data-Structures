/**~*~*
 Stack template
 *~**/
#ifndef __Data_Stuctures_Homework__2__Stack__
#define __Data_Stuctures_Homework__2__Stack__
#include <iostream>
using namespace std;
...
#endif /* defined(__Data_Stuctures_Homework__2__Stack__) */
